...
public class ChangeSecurityQuestionAnswer {
	public String changeSecurityQuestionAnswer(String existingPhoneNumber, String existingEmail,
			String existingSecurityPin, String idNumber, String existingSecurityQuestion,
			String existingSecurityQuestionAnswer, String newSecurityQuestionAnswer) {
		String result = null;
