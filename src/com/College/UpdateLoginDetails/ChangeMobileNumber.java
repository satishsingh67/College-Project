...
public class ChangeMobileNumber {
	public String changeMobileNumber(String existingEmail, String existingPhoneNumber, String newPhoneNumber,
			String idNumber, String existingSecurityPin, String existingSecurityQuestion,
			String existingSecurityQuestionAnswer) {
		String result = null;
