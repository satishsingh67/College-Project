...
public class ViewVariables {
	...
	private String categoriesOfComplainant;
	private String link;
	...
	public String getCategoriesOfComplainant() {
		return categoriesOfComplainant;
	}

	public void setCategoriesOfComplainant(String categoriesOfComplainant) {
		this.categoriesOfComplainant = categoriesOfComplainant;
	}
	...
	public String getUniversityRegistrationNo() {
		return universityRegistrationNo;
	}

	public void setUniversityRegistrationNo(String universityRegistrationNo) {
	...
	public String getGurdianEmailid() {
		return gurdianEmailid;
	}

	public void setGurdianEmailid(String gurdianEmailid) {
		this.gurdianEmailid = gurdianEmailid;
	}
