...
studentList=new SubjectAllotmentDao().fetchStudentList(courseType, departmentId, year, sectionId);
...
<header class="header">
  ...
  <select class="custom-select"  id="studentDropdown"  multiple="multiple">
   ...
   <%
	   List<ViewVariables> list=(List<ViewVariables>)studentList.get("studentList");
	   if((boolean)studentList.get("status")&& list.size()!=0 ){
   %>
