      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./canvasBeyondCurricualm.jsp">Beyond Curriculam</a>
            </li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-md-6">
            ...
            <div class="mt-4">
                <h3 style="font-weight: bold;font-size: 40px; font-family: 'Times New Roman', Times, serif;">Read <br>& <br> Write What is in your Mind</h3>
          ...
          <div class="col-lg-5 col-md-6">
            ...
            <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_xjk0nckm.json"  background="transparent"  speed="1"  style="width: 500px; height: 500px;"  loop  autoplay></lottie-player>
          </div>
        </div>
      </div>
    </div>
