...
<header class="header">
	...
	<H3 style="text-align: center">Grievance History</H3>
		...
		<table id="customers">
			...
			<thead>
				<tr>
					...
					<th style="text-align: center;">Addressing Department</th>
	 ...
	 function myFunction(){
		...
		*/
		 function grievance(){
	     	 ...
	     	 $.ajax({
			      type: "GET",
			      url:"/College_Final_Year_Project/fetch?action=grievance",
			      success: function (data, textStatus, jqXHR) {
			          ...
			          $(JsonData).each(function (index, item) {  
			        	 ...
			        	 $('#Table').append(
			        			...
			        			'<td style="text-align: center;display:none;">'+item.pkId+'</td>'+
			        			 ...
			        			 '<td style="text-align: center;font-size: 15px;">'+item.userType+'</td>'+
			        			 ...
			        			 '<td style="text-align: center;font-size: 15px;">'+item.categoriesOfComplainant+'</td>'+
