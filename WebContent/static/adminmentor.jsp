          ...
          <nav class="navbar">
             ...
             <main>
                ...
                <section id="reg" style="background-image: url(./images/background/back7.jpg) ;background-repeat: no-repeat; background-size: cover;">
                    <h1 class="heading">Assign New <span>Mentor </span> </h1>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-7">
                                <form id="mentorAccountForm" style="border: 1px solid red;height:530px;">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <span style="font-family: 'Times New Roman', Times, serif;font-weight: bold;">Mentor Name:<strong class="text-danger">*</strong></span>
										...
										<div class="form-check" style="height:80px;">
										<br>
											<input class="form-check-input" style="height:20px;width:20px;" type="radio"
												name="section" value="1" id="flexRadioDefault1">
									 <span  style="font-family: 'Times New Roman', Times, serif;font-weight: bold;margin-left:20px;">I</span>
												
										<br>
										<input class="form-check-input" style="height:20px;width:20px;" type="radio"
												name="section" value="2" id="flexRadioDefault2" checked>
									   <span style="font-family: 'Times New Roman', Times, serif;font-weight: bold;;margin-left:20px;margin-top:30px;">II</span>
                                    ...
                                    <input type="submit" value="Create" name="submit" id="mentorAccountCreateButton" class="link-btn" style="margin-right: 5px; background-color: black;">
                                    <input type="submit" value="Cancel" name="submit" id="accountClear" class="link-btn" style="background-color: black;">
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          <form id="deleteAccountForm"  style="border:1px solid red;height:300px;">
                              ...
                              <input type="submit" value="Cancel" name="submit" id="delteAccountClear" class="link-btn"  style="background-color: black;">
                           </form>   
                      </div>
                    </div>
                </div>
...
<!-- View Question Paper Modal end -->      
          ...
          function myFunction(){
     	         ...
     	         var question=$('#question'+id).val();
     	             ...
     	             $('#teacherName').text("Mentor Name: "+name);
          ...
          $('#mentorAccountCreateButton').click(function (event){
  		    event.preventDefault();
  		...
  		$(".loader1").show();
  		    ...
  		    var form = $('#mentorAccountForm')[0];
  		    // Create an FormData object 
  		    var data = new FormData(form);
  		    data.append("action", "mentorAccount");
  		    // disabled the submit button
  		    $("#mentorAccountCreateButton").prop("disabled", true);
  		    $.ajax({
  		      type: "POST",
  		      enctype: 'multipart/form-data',
  		      url: "/College_Final_Year_Project/mentorNew",
  		      data: data,
  		      processData: false,
  		      contentType: false,
  		      success: function (data, textStatus, jqXHR) {
  		        ...
  		        if (data.trim().includes("Successfully")) {
  		          swal("Done", data, "success");
  		        $('#mentorAccountForm')[0].reset();
  		        }
  		        else {
  		          swal("Error", data, "error");
  		        }
		         
  		        $("#mentorAccountCreateButton").prop("disabled", false);
  		      },
  		      error: function (jqXHR, textStatus, errorThrown) {
  		        $(".loader1").hide();
  		        $('#myModal').hide();
    ...
    $('#accountClear').click(function (event){
	    event.preventDefault();
        $('#mentorAccountForm')[0].reset();
    ...
    $('#delteAccount').click(function (event){
		...
		$(".loader1").show();
		    ...
		    // Create an FormData object 
		    var data = new FormData(form);
		    data.append("action", "mentorAccountDelete");
		    // disabled the submit button
