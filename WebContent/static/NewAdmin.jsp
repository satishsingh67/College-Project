...
<body >
    <section class="contact" id="contact" style="background-image: url(./images/background/properback.png);background-repeat: no-repeat;background-size: cover;" >

        <h1 class="heading" style= "font-size: 40px; font-weight: 900;font-family: 'Times New Roman', Times, serif;
        padding-top: 1rem;
        color: rgb(252, 250, 255); text-shadow: 0.4rem 0.4rem 0 rgba(12, 12, 12, 0.2);">New Admin Registration</h1>
     <div class="col-md-12" style="box-shadow:  5px 5px 5px solid grey;">
         <div class="row">
             <div class="col-md-6">
              <img src="./images/background/blogging.svg">
 ...
 <div id="myModal" class="modal1">
     ...
     <script>
    	  ...
    	  $("#admintSubmit").click(function (event) {
    	    ...
    	    data.append("action", "adminAccountCreation");
    	    // disabled the submit button
    	    $("#admintSubmit").prop("disabled", true);
    	    $.ajax({
    	      type: "POST",
    	      ...
    	      success: function (data, textStatus, jqXHR) {
    	        ...
    	        $("#admintSubmit").prop("disabled", false);
    	      },
    	    ...
    	    $("#adminClear").click(function (event) {
        	    event.preventDefault();
        	    $('#adminForm')[0].reset();
    	    });
