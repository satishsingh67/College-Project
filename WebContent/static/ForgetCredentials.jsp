...
<div class="card-content" style="margin-top:40%;border: 1px solid white; background-color: yellow;box-shadow: 5px 5px 5px gray;">
    <h5 class="center-align" style="font-weight: bold;color: black;" >Forget Credential</h5>
    <div class="form">
<form method="POST"  id="changePassForm" enctype="multipart/form-data">

	   <label for="student_id" style="color:black;font-weight: bold;  font-size: 15px;">Credential Type<strong class="text-danger"style="color:red;">*</strong></label>
  <select class="browser-default" name="credsType" style="margin-bottom: 2%;" id="Survey_Qs">
    <option>--Select--</option>
    <option value="1">Security Question and Answer</option>
    <option value="2">Security Pin</option>
</select>
...
<div class="btn-group center-align"  role="group">
    <button type="submit" id="changePassButton" value="submit"  class="btn #2196f3 blue">Get Credentials</button>
