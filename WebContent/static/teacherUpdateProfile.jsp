...
<form method="POST"  id="updateDeatilsTeacher" enctype="multipart/form-data">
    ...
    <label for="mentor_mail" style="color:black; font-weight: bold; font-size: 15px;">Designation</label>
    <input readonly id="teacherDesignation" type="text" class="validate">
      <label for="mentor_mail" style="color:black; font-weight: bold; font-size: 15px;">Department</label>
    <input readonly id="teacherDepartment" type="text" class="validate">
<label for="first_name" style="color:black; font-weight: bold;font-size: 15px;">Mobile Number</label>
<input readonly id="teacherMobileNumber" type="text" class="validate">
...
<label  for="first_name" style="color:black; font-weight: bold;font-size: 15px;">Joining Date</label>
<input readonly type="text" id="teacherJoiningDate" class="validate">
...
function fetchTeacherDetails(teacherId){
	 ...
	 $.ajax({
	      type: "GET",
	      url:"/College_Final_Year_Project/teacherLogin?teacherId="+teacherId,
	      success: function (data, textStatus, jqXHR) {
	    	 ...
	    	 $('#teacherId').val(JsonData[0].pkTeacherId);
	    	 $('#teacherName').val(JsonData[0].techerName);
	    	 $('#teacherEmail').val(JsonData[0].emailId);
	    	 $('#teacherRecoveryEmailId').val((JsonData[0].recoveryEmailId)==null?"":JsonData[0].recoveryEmailId);
	    	 $('#teacherDesignation').val(JsonData[0].designation);
	    	 $('#teacherDepartment').val(JsonData[0].departmentName);
	    	 ...
	    	 $('#teacherJoiningDate').val(JsonData[0].joiningDate);
