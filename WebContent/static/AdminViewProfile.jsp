...
<div class="card-content" style="margin-top:20%;border: 1px solid white; background-color: yellow;box-shadow: 5px 5px 5px gray;">
    <h5 class="center-align" style="font-weight: bold;color: black;" >Profile</h5>
    <div class="form">
<form method="POST"  id="updateDeatilsTeacher" enctype="multipart/form-data">
<div style="width:50%;height:70%;margin-left:150px;">

       <img class="logo" id="adminImage" src="" style="width:70%; height:70%"> 
...
data.append("action", "adminDetails");
...
function fetchAdminDetails(adminId){
	 ...
	 $.ajax({
	      type: "GET",
	      url:"/College_Final_Year_Project/adminLogin?adminId="+adminId,
	      success: function (data, textStatus, jqXHR) {
	    	 ...
	    	 $('#adminImage').attr('src', 'data:image/png;base64,'+JsonData[0].base64Image);
	    	 $('#teacherId').val(adminId);
