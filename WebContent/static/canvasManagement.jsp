            ...
            <h2 class="text1 text-center">GURUNANAK INSTITUTE OF TECHNOLOGY</h2> 
             ...
             <main>
                ...
                <section id="reg" style="background-image: url(./images/background/back7.jpg) ;background-repeat: no-repeat; background-size: cover;">
                    <h1 class="heading">Assign Canvas<span> Co-ordinator </span> </h1>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
...
<lottie-player src="https://assets8.lottiefiles.com/packages/lf20_9wpyhdzo.json"  background="transparent"  speed="2"  style="width: 500px; height: 600px;"  loop  autoplay></lottie-player>  </div>
                                <div class="col-md-6">
                                <form id="canvasAccountForm"  style="border:2px solid skyblue;height:520px;" >
                                          ...
                                          <span style="font-family: 'Times New Roman', Times, serif;font-weight: bold;"> Password:<strong class="text-danger">*</strong></span>
                                            ...
                                            <input type="submit" value="Submit" name="Submit" id="acconutCreationButton" class="link-btn" style="margin-right: 5px;background-color: black;">
 ...
 <!-- Loader Modal end -->
       ...
       <script>
  		...
  		$(".loader1").show();
  		    ...
  		    var form = $('#canvasAccountForm')[0];
  		    // Create an FormData object 
  		    var data = new FormData(form);
  		    data.append("action", "canvasAccount");
  		    // disabled the submit button
  		    $("#acconutCreationButton").prop("disabled", true);
  		    $.ajax({
  		      type: "POST",
  		      ...
  		      success: function (data, textStatus, jqXHR) {
  		        ...
  		        $("#acconutCreationButton").prop("disabled", false);
  		      },
